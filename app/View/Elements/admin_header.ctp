<div id="admin_header" class="wrapper">
	<h2><?=$selected;?></h2>
<ul class="tabs">
	<li <? if($selected == 'Settings') { echo 'class="selected"'; } ?>>
    <?=$this->Html->link(__('Settings',true),'/admin');?>
  </li>
  <li <? if($selected == 'Question Settings') { echo 'class="selected"'; } ?>>
    <?=$this->Html->link(__('Question Settings',true),'/admin');?>
  </li>
	<li <? if($selected == 'Flagged Posts') { echo 'class="selected"'; } ?>>
    <?=$this->Html->link(__('Flagged Posts',true),'/admin/flagged');?>
  </li>
